      ...
      <ContactDetail>
        ...
        >
          <g transform="translate(0,87) scale(0.1,-0.1)" stroke="none">
            ...
            />
            <path
              d="M260 583 c0 -5 15 -14 34 -21 18 -7 41 -21 51 -32 21 -24 37 -26 29
-5 -10 26 -114 79 -114 58z"
            />
            <path d="M345 255 c61 -13 81 -11 55 5 -8 6 -37 9 -65 9 l-50 -1 60 -13z" />
            <path
              d="M345 104 c-75 -38 -139 -83 -131 -91 2 -3 25 9 50 26 25 18 75 45
        ...
        <IconGroup>
          ...
          >
            <g transform="translate(0,114) scale(0.1,-0.1)" stroke="none">
              <path
                d="M325 893 c9 -70 16 -93 27 -93 6 0 7 7 4 16 -3 9 -9 40 -12 70 -4 30
-11 54 -16 54 -6 0 -7 -20 -3 -47z"
              />
              <path d="M410 876 c0 -31 4 -56 9 -56 11 0 11 99 -1 106 -4 3 -8 -20 -8 -50z" />
              <path
                d="M506 911 c-11 -17 -24 -101 -16 -101 10 0 34 99 27 106 -3 3 -8 1
-11 -5z"
              />
              <path
                d="M560 845 c-13 -27 -26 -53 -28 -57 -2 -5 1 -8 6 -8 13 0 55 86 50
102 -3 7 -15 -9 -28 -37z"
              />
              <path
